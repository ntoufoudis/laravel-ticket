...
<div>
    <form wire:submit="register">
        ...
        <div>
            ...
            <x-breeze.text-input wire:model="name" id="name" class="block mt-1 w-full" type="text" name="name" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-breeze.text-input wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-breeze.text-input wire:model="password" id="password" class="block mt-1 w-full"
                          type="password"
                          name="password"
